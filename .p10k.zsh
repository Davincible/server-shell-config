# Generated by Powerlevel10k configuration wizard on 2021-05-03 at 21:39 CEST.
...
# round separators, round heads, flat tails, 2 lines, solid, full frame, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND="white" # 31
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND="white" #103
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND="white" #39
